...
public class AppTest extends TestBase {
    ...
    @Test(groups = {"AppTest"},enabled=true)
    ...
    @Test(groups = {"AppTest"},dependsOnMethods = {"login"},enabled=true)
    ...
    @Test(groups = {"AppTest"}, dependsOnMethods = {"openMenu"},enabled=false)
    public void factorySearchFail() throws Exception {
        /**
         * 以下是操作工厂管理查询的代码
         */
    ...
    @Test(groups = {"AppTest"}, dependsOnMethods = {"openMenu"},enabled=true)
...
//        webDriver.switchTo().parentFrame();
     ...
     * 退出登录
     */
    @Test(groups = {"AppTest"},dependsOnMethods = {"openMenu"}, alwaysRun = true)
